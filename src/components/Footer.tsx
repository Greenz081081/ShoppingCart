...
export default function Footer() {
    return (
      <footer className="py-6 px-6 bg-gray-900 bg-header3 mt-20">
        <div className="max-w-3xl mx-auto flex flex-col items-center text-2xl">
          ...
          <p className='text-center text-lg mb-2'>Copyright &apos; 2023 | Emerald&apos;s Cart | Brigham Young University - Idaho.</p>
